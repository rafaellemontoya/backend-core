      ...
      <tr>
        <td width="602" bgcolor="#bbbbbb" style="padding-left:1px; padding-right:1px; padding-top:1px;"><table width="600" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
          ...
          <tr>
            <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><span style="font-family:Arial, Helvetica, sans-serif;font-size:13px;color:#444444; margin-top:5px; margin-bottom:5px;">Se ha confirmado tu asistencia al  evento: Junta Nacional de Afiliados 2019 </span></td>
              </tr>
            </table></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><span style="font-family:Arial, Helvetica, sans-serif;font-size:13px;color:#444444; margin-top:5px; margin-bottom:5px;">N&uacute;mero de Registro: <strong>'.$id.' </strong><br>
                  <br>
                  Nombre: <strong>'.$nombre.' '.$apellidoPaterno.' '.$apellidoMaterno.'</strong><br>
                  <br>
                  Email: <strong>'.$email.'</strong><br>
                  <br>
                  Fecha de llegada: '.$llegada.'<br>
                  <br>
                  Fecha de Salida: '.$salida.'<br>
                  <br>
                </span></td>
              </tr>
            </table></td>
